export default {
  ...
  head: {
    ...
    link: [
      ...
      {rel: "apple-touch-icon", sizes: "180x180", href: "/ekonomicznykod/apple-touch-icon.png"},
      {rel: 'icon', type: 'image/png', sizes: "32x32", href: '/ekonomicznykod/favicon-32x32.png'},
      {rel: "icon", type: "image/png", sizes: "16x16", href: "/ekonomicznykod/favicon-16x16.png"},
      {rel: "manifest", href: "/ekonomicznykod/site.webmanifest"}
