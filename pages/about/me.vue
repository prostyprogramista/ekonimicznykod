<template>
    <main>
      <section class="about-me-page">
          ...
          <p>
            W squasha gram od 2018 roku. Od samego początku wiedziałem, że to jest to! Uwielbiam ten sport - uwielbiam jego dynamikę, intensywność oraz to, że cały czas trzeba myśleć 
            i starać się przewidywać ruchy przeciwnika pomimo tego, że wcale nie ma na to zbyt wiele czasu :D
          </p>
          <p>
            Jeśli też grasz już dłuższy czas, jesteś z Krakowa i chciałbyś zagrać jakiś meczyk to pisz śmiało :)
          </p>
          ...
          <p>
            Gotowanie to coś co mnie odpręża i pozwala oderwać od codziennych problemów. W kuchni czuję się bardzo swobodnie - lubię eksperymentować i próbować nowych rzeczy, 
            jednocześnie nienawidzę trzymać się sztywno przepisów :D Dla mnie gotowanie to improwizacja i łamanie schematów. Każda kolejna potrawa wnosi mój instynkt kulinarny na kolejny 
            poziom dzięki czemu moja improwizacja jest zjadliwa :D
          </p>
          ...
          <p>
            Światem finansów zacząłem się interesować jakoś w pierwszej połowie roku 2020. Na początku nie miałem ambicji zgłębiać tego tematu jakoś szczególnie, chciałem tylko dowiedzieć 
            się nieco więcej na temat rozsądniejszych sposobów przechowywania swoich oszczędności. Na początku obejrzałem tylko kilka wywiadów z ludźmi, którzy się tym zajmowali na co dzień. 
            To co tam znalazłem bardzo pozytywnie mnie zaskoczyło i zachęciło do dalszej eksploracji tematu. Im dłużej go zgłębiałem, tym bardziej zacząłem wsiąkać :D Nawet w pewnym 
            momencie zabrałem się za czytanie wybranych książek o tematyce ekonomicznej i inwestycyjnej - które swoją drogą dały mi dużo szersze spojrzenie na świat finansów i uświadomiły 
            mi jak bardzo pozornie niezwiązane ze sobą rzeczy, wzajemnie na siebie oddziałują.
          </p>
